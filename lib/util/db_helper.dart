...
class DbHelper {
  ...
  Future<Database> initializeDb() async {
    ...
    final db = await openDatabase(p, version: 1, onCreate: _createDb);
    return db;
  }
  ...
  Future<List<Map<String, dynamic>>> getDoc(int id) async {
    Database? db = await this.db;
  ...
  Future<List<Map<String, dynamic>>?> getDocFromStr(String payload) async {
